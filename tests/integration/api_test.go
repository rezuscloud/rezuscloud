...
func newTestServer(t *testing.T) *testServer {
	...
	handler := api.Router(store, jwtManager, auditComponent, nil, upgrade.NewManager(store, upgrade.NoOpMachineUpgrader{}, upgrade.NewStoreMachineLister(store)), nil, nil)
