...
| [0008](0008-config-delivery-user-data-and-talos-api.md) | Config Delivery via SideroLink Config-Pull | Accepted (reverses prior push; [planned #194](https://github.com/rezuscloud/rezuscloud/issues/194)) |
